...
root_directory = '/home/duongnguyen/git/tvtmaaddons/tvtmaaddons16' # Name your directory contain odoo code here, you can switch to list to support multi and don't forget to modified the code below
folder_types = ['view', 'views', 'wizard', 'wizards', 'report', 'reports']
...
def migrate_view_appocalypse(cr):
    ...
    for subdir, dirs, files in os.walk(root_directory):
        for folder_type in folder_types:
            if folder_type in dirs:
                views_folder = os.path.join(subdir, folder_type)
